#ifndef TOOLS_STACK_VECTOR_HPP
#define TOOLS_STACK_VECTOR_HPP
...
template <typename Contained, std::size_t Capacity> struct simple_stack_vector {
  ...
  constexpr explicit simple_stack_vector(
  ...
  constexpr explicit simple_stack_vector(
      const simple_stack_vector<OtherContained, OtherSize> &other) {
...
operator==(const simple_stack_vector<Contained, LHSSize> &lhs,
