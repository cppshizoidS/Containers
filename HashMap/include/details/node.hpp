#ifndef CPPSHIZ_NODE_HPP
#define CPPSHIZ_NODE_HPP
...
#ifdef CPPSHIZ_STRICT_TYPE_PUNNING
...
struct uses_allocator<cppshiz::details::node<Key, T>, Allocator> : true_type
{
};
} // namespace std
#endif // CPPSHIZ_NODE_HPP